...
<head>
    ...
    <base href="http://www.gojs.net/latest/samples/" target="_blank"/>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/gojs/1.7.5/go-debug.js"></script>
    <!-- Scripts -->
    <script>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        ...
                        <li><a href="{{ url('/peticion') }}">Peticion</a></li>
                    @else
                        <li class="dropdown">
