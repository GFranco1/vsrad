    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="panel col-sm-8 panel-default ">
                ...
                <div class="panel-body text-center">
                        <form class="form-horizontal" role="form" method="GET" action="{{ url('guardarnuevaconfiguracion')}}">
                            {{ csrf_field() }}
                            ...
                            @if($proyecto->class_casa == 'canvas-casa-1')
                                <p><b>Utilizar plano</b> Casa 1</p>
                            @endif
                            @if($proyecto->class_casa == 'canvas-casa-2')
                                <p><b>Utilizar plano</b> Casa 2</p>
                            @endif
                            @if($proyecto->class_casa == 'canvas-casa-3')
                                <p><b>Utilizar plano</b> Casa 3</p>
                            @endif
                            @if($proyecto->class_casa == 'canvas-casa-4')
                                <p><b>Utilizar plano</b> Casa 4</p>
                            @endif
                            @if($proyecto->class_casa == 'canvas-casa-5')
                                <p><b>Utilizar plano</b> Casa 5</p>
                            @endif
                            ...
                            <input type="hidden" id="casa"  name="id" value="{{$proyecto->id_cliente}}">
                            <input type="hidden" id="casa"  name="id_proyecto" value="{{$proyecto->id}}">
