    ...
    <div class="container">
        <div class="row content">
            <div class="col-sm-2 panel panel-default">
                <form action="{{url('cambiarestado2',$proyecto->id)}}" method="GET">
                    {!! csrf_field() !!}
                ...
                <div class="panel-body">
                    ...
                    <p><b>Nombre de proyecto:  </b>{{$proyecto->nombre}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Precio:  </b>{{$proyecto->precio}}&euro;</p>
                        ...
                        <div style="position: relative;">
                            ...
                            <div id="myDiagramDiv" style="position: absolute; width:100%; height:70%; z-index: 2;" >
                            </div>
            ...
            <div class="col-sm-2 panel panel-default">
                <a href="{{url('/nuevomapa',$proyecto->id)}}">
                    <button type="button" class="btn btn-primary  btn-block">Crear Nuevo</button>
                </a>
            </div>
        </div>
    </div>
