        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Enviar mensaje a cliente</div>
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('mensajeria.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('asunto') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <p>{{$mensaje->asunto}}</p>
                                    <input id="asunto" type="hidden" class="form-control" name="asunto" value="{{$mensaje->asunto}}">
